...
class DTCWT(torch.nn.Module):
    """Performs a 1D dual tree wavelet transform of a PyTorch tensor.
    """

    def __init__(self, level1, qshift, J, skip_hps, include_scale, alternate_gh, padding_mode, normalize):
        ...
        # g0o is the inverse low-pass filter.
        # g1o is the inverse high-pass filter.
...
class DTCWTDirect(DTCWT):
    ...
    def __init__(self,
        ...
        # Instantiate PyTorch NN Module
        super().__init__(level1, qshift, J, skip_hps, include_scale, alternate_gh, padding_mode, normalize)
...
class DTCWTInverse(DTCWT):
    """Performs a DTCWT reconstruction of a sequence of 1-D signals. 
